  ...
  return (
    <div className="p-4 sm:p-6 font-sans">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8 gap-4">
        ...
        <div className="relative w-full sm:w-64">
          <input
            ...
            className="w-full px-4 py-2 rounded-xl border border-gray-200 bg-white/80 backdrop-blur-sm focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent"
          />
      ...
      {(userRole === 'treasurer' || userRole === 'admin') && (
        <div className="mb-6 sm:mb-8 bg-white/80 backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-lg border border-gray-100">
          ...
          <table className="w-full min-w-full">
            <thead>
              <tr className="bg-gradient-to-r from-gray-50 to-gray-100">
                <th className="text-left p-3 sm:p-4 font-semibold text-gray-700 text-sm sm:text-base">Member Code</th>
                <th className="text-left p-3 sm:p-4 font-semibold text-gray-700 text-sm sm:text-base">Name</th>
                <th className="text-left p-3 sm:p-4 font-semibold text-gray-700 text-sm sm:text-base">Role</th>
                <th className="text-left p-3 sm:p-4 font-semibold text-gray-700 text-sm sm:text-base">Balance</th>
                {(userRole === 'treasurer' || userRole === 'admin') && (
    ...
    <td className="p-3 sm:p-4 space-x-2">
      ...
      <button onClick={cancelEdit} className="bg-gray-500 hover:bg-gray-600 text-white px-3 py-1 rounded-lg transition-colors text-sm">
        ❌ Cancel
                      ...
                      <>
                        <td className="p-3 sm:p-4">
                          <div className="font-bold text-purple-600 text-sm sm:text-base">#{m.member_code}</div>
                        </td>
                        <td className="p-3 sm:p-4 font-medium text-gray-800 text-sm sm:text-base">{m.name}</td>
                        <td className="p-3 sm:p-4">
                ...
                <tr>
                  <td colSpan={canEditDelete ? "5" : "4"} className="p-8 text-center text-gray-500">
          ...
          <div className="bg-white rounded-2xl p-6 w-full max-w-md shadow-xl animate-in fade-in-zoom-in">
            ...
            <div className="space-y-3">
              <div className="flex justify-between">
                ...
                <span className="font-medium">#{viewMember.member_code}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-green-600">Ksh {viewMember.balance?.toLocaleString() || '0'}</span>
              </div>
              {(userRole === 'treasurer' || userRole === 'admin') && (
                <>
                  <div className="flex justify-between">
